...
HD_PWD='C:/Users/Engineering/projekt_sdup/projekt_sdup.runs/design_AXI_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_AXI_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_AXI_rst_ps7_0_100M_0.tcl
