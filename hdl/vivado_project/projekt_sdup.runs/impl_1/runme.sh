...
HD_PWD='C:/Users/Engineering/projekt_sdup/projekt_sdup.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_AdjustCoeffsAXI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_AdjustCoeffsAXI_wrapper.tcl -notrace
