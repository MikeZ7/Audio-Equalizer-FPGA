...
HD_PWD='C:/Users/Engineering/projekt_sdup/projekt_sdup.runs/design_AXI_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_AXI_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_AXI_clk_wiz_0_0.tcl
