...
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD SSTL135 } [get_ports { sys_clock }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_clk[200]
#create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5.000}  [get_ports { sys_clock }];

## Switches
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {control_signal_0[0]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {control_signal_0[1]}]
...
## LEDs
#set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports sample_valid_out_0]
#set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports sample_valid_out_1]
#set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports sample_valid_out_2]
#set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports sample_valid_out_3]
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports i2s_mclk_dac_0]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports i2s_lr_dac_0]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports i2s_bclk_dac_0]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports i2s_dout_0]
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports i2s_mclk_adc_0]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports i2s_lr_adc_0]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports i2s_bclk_adc_0]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports i2s_din_0]
...
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports uart_rx_serial_0]
...
#set_property RESOURCE_SHARING true [current_design]
#set_param synth.elaboration.rodinMoreOptions "-resource_sharing yes"
...
#set_property USE_DSP no [get_cells -hierarchical {gen_filters[*].IIR_Filter}]


#set_property USE_DSP yes [get_cells -hierarchical]
