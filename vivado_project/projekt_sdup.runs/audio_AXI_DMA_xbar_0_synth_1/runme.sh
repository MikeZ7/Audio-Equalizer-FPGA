...
HD_PWD='C:/Users/Engineering/projekt_sdup/projekt_sdup.runs/audio_AXI_DMA_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_AXI_DMA_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_AXI_DMA_xbar_0.tcl
