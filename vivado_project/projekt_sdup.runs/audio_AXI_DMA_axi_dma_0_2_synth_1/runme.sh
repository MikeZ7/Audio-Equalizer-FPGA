...
HD_PWD='C:/Users/Engineering/projekt_sdup/projekt_sdup.runs/audio_AXI_DMA_axi_dma_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_AXI_DMA_axi_dma_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_AXI_DMA_axi_dma_0_2.tcl
