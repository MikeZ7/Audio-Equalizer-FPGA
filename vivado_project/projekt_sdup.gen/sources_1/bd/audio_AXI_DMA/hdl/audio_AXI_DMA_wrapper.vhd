...
--Command     : generate_target audio_AXI_DMA_wrapper.bd
--Design      : audio_AXI_DMA_wrapper
...
entity audio_AXI_DMA_wrapper is
  port (
...
end audio_AXI_DMA_wrapper;

architecture STRUCTURE of audio_AXI_DMA_wrapper is
  component audio_AXI_DMA is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component audio_AXI_DMA;
begin
audio_AXI_DMA_i: component audio_AXI_DMA
     port map (
